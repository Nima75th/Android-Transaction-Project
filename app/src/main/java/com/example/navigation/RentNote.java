...
public class RentNote {
    ...
    public RentNote(int ID, int DAY, int MONTH, int YEAR, String RENTER, String SON_OF, long MELI_NUMBER, String FROM_WHERE, long MELI_CODE, String BIRTH_OF, String ADDRESS, long POST_CODE, long TELEPHONE, long MOBILE) {
        this.ID = ID;
        this.DAY = DAY;
        this.MONTH = MONTH;
        this.YEAR = YEAR;
    ...
    public RentNote(int DAY, int MONTH, int YEAR, String RENTER, String SON_OF, long MELI_NUMBER, String FROM_WHERE, long MELI_CODE, String BIRTH_OF, String ADDRESS, long POST_CODE, long TELEPHONE, long MOBILE) {
        this.DAY = DAY;
        this.MONTH = MONTH;
        this.YEAR = YEAR;
        this.RENTER = RENTER;
